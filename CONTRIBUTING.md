...
- Match the existing design language. Tuxmeter has a specific look and feel.
...
You can also [open an issue](https://github.com/robinebers/tuxmeter/issues/new?template=new_provider.yml) to request a provider without building it yourself.
...
Don't open a PR for large features without discussing first. [Open an issue](https://github.com/robinebers/tuxmeter/issues/new?template=feature_request.yml) and make your case.
...
Open a [bug report](https://github.com/robinebers/tuxmeter/issues/new?template=bug_report.yml) or [feature request](https://github.com/robinebers/tuxmeter/issues/new?template=feature_request.yml) using the issue templates.
