...
Tuxmeter is a GUI app. A one-off `export ...` in a terminal session will not be visible when you launch Tuxmeter from
Spotlight/Launchpad. Persist it, then restart Tuxmeter.
...
3. Enable the Z.ai plugin in Tuxmeter settings
